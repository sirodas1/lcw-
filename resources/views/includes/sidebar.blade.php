<div class="h-screen w-72 fixed z-50 top-0 left-0 bg-white overflow-x-hidden pt-4 md:pt-5">
    ...
    <div class="flex justify-center mt-10">
        <div class="basis-9/12">
            <button class="bg-red-400 rounded-lg text-gray-50 hover:bg-red-600 hover:text-light py-2 px-2 w-full" onclick="window.location.href = '{{route('dashboard')}}';">
    ...
    <div class="mt-8 flex justify-center">
        <div class="basis-10/12">
            <div class="flex flex-col">
                ...
                <a href="#" class="mt-3 text-gray-800 hover:text-red-400">
                    <span class="text-red-400"><i class="fa fa-map-location-dot"></i></span>&emsp; 
                    Zones 
                    <span class="float-right"><i class="fa fa-chevron-right"></i></span>
                </a>
                <a href="#" class="mt-3 text-gray-800 hover:text-red-400">
