<div {{ $attributes->merge(['class' => 'group border-2 bg-white border-red-300 rounded-lg p-5 hover:border-red-400 hover:bg-red-400 hover:cursor-pointer shadow-sm hover:shadow-lg'])}}>
