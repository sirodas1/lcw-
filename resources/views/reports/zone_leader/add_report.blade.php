<x-app-layout>
  ...
  <div class="bg-gray-50 border border-red-300 rounded-lg shadow-md mt-12 ml-5 mr-20 mb-10">
    ...
    <form action="{{route('reports.save')}}" method="post">
      ...
      <div class="flex justify-center gap-6 mt-8 px-6 mb-5">
        <div class="basis-1/2">
          <div class="flex justify-center gap-4">
            ...
            <x-text-input class="w-1/2" name="sunday_date" type="date" value="{{old('sunday_date')}}" required/>
          </div>
        </div>
        <div class="basis-1/2">
          <div class="flex justify-center gap-4">
            <x-input-label for="arrival_time" class=" pt-2 text-base">Enter Arrival Time * : </x-input-label>
            <x-text-input class="w-1/2" name="arrival_time" type="time" value="{{old('arrival_time')}}" required/>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 gap-6 px-6 mb-5 mt-5">
